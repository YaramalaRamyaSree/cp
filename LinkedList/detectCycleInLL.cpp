...
*/
    ...
    /*Another approch in datastructure of Node add flag also every time u traverse make flag 1 and 
      traverse when ever u see alredy node's flag as 1 return true else false
    
      Approch -without changing datastructure of Node also we can make use  flag concept how??
